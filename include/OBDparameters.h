...
extern "C" {
    ...
    typedef enum {
        ...
        ENGINE_LOAD = 0x0104,
        ENGINE_COOLANT_TEMP = 0x0105,
        INTAKE_PRESSURE = 0x010B,
        ENGINE_RPM = 0x010C,
        ...
        FUEL_RAIL_PRES_ALT = 0x0123,
        BAROMETRIC_PRESSURE = 0x0133,
        O2S1_WR_LAMBDA_I = 0x0134,
        REL_THROTTLE_POS = 0x0145,
        AMB_AIR_TEMP = 0x0146,
        ACCEL_POS_D = 0x0149,
        ACCEL_POS_E = 0x014A,
